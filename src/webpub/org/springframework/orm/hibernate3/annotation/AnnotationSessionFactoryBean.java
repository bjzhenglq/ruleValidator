 ...
 * 
 * <p>
 * Note: This class requires Hibernate 3.2 or later, with the Java Persistence
...
public class AnnotationSessionFactoryBean extends LocalSessionFactoryBean
	...
	/**
	 * Specify packages to search using Spring-based scanning for entity classes
	 * in the classpath. This is an alternative to listing annotated classes
	 * explicitly.
	 * <p>
	 ...
	 * <code>@javax.persistence.MappedSuperclass</code>, as well as for
	 ...
	 * {@link #postProcessAnnotationConfiguration}.
	 */
	@Override
	 ...
	 * <p>
	 * Note: As of Hibernate 3.6, AnnotationConfiguration's features have been
	 * rolled into Configuration itself. Simply overriding
