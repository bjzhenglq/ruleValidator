define('jasmineh', ['tools/jasmine/jasmine', 'tools/jasmine/jasmine.css'], function(
		require) {

	require('tools/jasmine/jasmine');
		...
		self.log = function() {
			...
			if (console && console.log) {
				if (console.log.apply) {
					...
					console.log(arguments); // ie fix: console.log.apply doesn't
											// exist on ie
				}
			}
		};
	...
	jasmine.HtmlReporter.ReporterView = function(dom) {
		...
		this.createResultsMenu = function() {
			this.resultsMenu = this.createDom('span', {
						className : 'resultsMenu bar'
								...
								href : "#"
							}, '0 specs'), ' | ', this.detailsMenuItem = this
							.createDom('a', {
		...
		this.refresh = function() {
			...
			this.skippedAlert.innerHTML = "Skipping " + this.skippedCount
					+ " of " + specPluralizedFor(this.totalSpecCount)
					+ " - run all";
			...
			this.failedAlert.innerHTML = "Failing "
					+ specPluralizedFor(this.failedCount);
		...
		this.complete = function() {
			...
			this.skippedAlert.innerHTML = "Ran " + this.runningSpecCount
					+ " of " + specPluralizedFor(this.totalSpecCount)
					+ " - run all";
			...
			dom.banner.appendChild(this
					.createDom('span', {
								className : 'duration'
							}, "finished in "
									+ ((new Date().getTime() - this.startedAt
											.getTime()) / 1000) + "s"));
		};
