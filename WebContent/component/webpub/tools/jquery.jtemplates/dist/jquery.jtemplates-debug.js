 ...
 */
define("jquery.jtemplates-debug", [], function(require, exports, module) {
    return function(jQuery) {
        (function(jQuery) {
            ...
            /**
				 ...
				 * @type integer
				 */
            Template.FOREACH_LOOP_LIMIT = 1e4;
            /**
				 * Global guid
				 * 
				 * @type integer
            ...
            TemplateUtils.cloneData = function(d, filter, f_escapeString) {
                ...
                switch (d.constructor) {
                  ...
                  case Function:
                    if (filter.noFunc) {
                        if (Template.DEBUG_MODE) throw new Error("jTemplates: Functions are not allowed."); else return undefined;
                    }
                }
                return d;
            };
            ...
            opFOREACH.prototype.get = function(d, param, element, deep) {
                try {
                    ...
                    // start, end and step
                    var s = Number(this._template.getBin().evaluate(d, param, element, this._option.begin) || 0), e;
                    // start,
                    // end
            ...
            jQuery.fn.setParam = function(name, value) {
                return jQuery(this).each(function() {
                    ...
                    if (t === undefined) {
                        if (Template.DEBUG_MODE) throw new Error("jTemplates: Template is not defined."); else return;
                    }
