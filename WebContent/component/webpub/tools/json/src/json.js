define(function(require, exports, module) {
	 ...
	 * 
	 * object.toJSONString(whitelist) This method produce a JSON text from a
	 * JavaScript value. It must not contain any cyclical references. Illegal
	 ...
	 * 
	 * The object and array methods can take an optional whitelist argument. A
	 * whitelist is an array of strings. If it is provided, keys in objects not
	 * found in the whitelist are excluded.
	 * 
	 * string.parseJSON(filter) This method parses a JSON text to produce an
	 ...
	 * received, then structure is not modified. If it returns undefined then
	 * the member is deleted.
	 * 
	 * Example:
	 *  // Parse the text. If a key contains the string 'date' then // convert
	 * the value to a date.
	 * 
	 ...
	 * parse, parseJSON, prototype, push, replace, slice, stringify, test,
	 * toJSON, toJSONString, toString, valueOf
	 */
