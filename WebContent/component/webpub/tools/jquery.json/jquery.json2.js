 ...
 */
		...
		(function($) {
			...
			/**
			 * jQuery.toJSON Converts the given argument into a JSON
			 * respresentation.
			 * 
			 * @param o
			 ...
			 * representation. Non-integer/string keys are skipped in the
					...
					: function(o) {
						...
						if (type === 'object') {
							...
							if (o.constructor === Date) {
								var month = o.getUTCMonth() + 1, day = o
										.getUTCDate(), year = o
										.getUTCFullYear(), hours = o
										.getUTCHours(), minutes = o
										.getUTCMinutes(), seconds = o
										.getUTCSeconds(), milli = o
										.getUTCMilliseconds();
							...
							for (var k in o) {
								...
								if (type === 'number') {
									...
									// Keys must be numerical or string. Skip
									// others
									continue;
								}
								type = typeof o[k];
								...
								if (type === 'function' || type === 'undefined') {
									...
									// shouldn't be included in the JSON string
									// at all.
									continue;
								}
								val = $.toJSON(o[k]);
			...
			/**
			 * jQuery.quoteString Returns a string-repr of a string, escaping
