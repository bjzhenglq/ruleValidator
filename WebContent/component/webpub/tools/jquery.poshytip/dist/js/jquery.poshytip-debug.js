define("jquery.poshytip-debug", [ "../../theme/default/css/tip-yellowsimple.css" ], function(require, exports, module) {
        ...
        (function($) {
            ...
            $.fn.poshytip = function(options) {
                if (typeof options == "string") {
                    ...
                    if (method == "destroy") this.die("mouseenter.poshytip").die("focus.poshytip");
            ...
            $.fn.poshytip.defaults = {
                ...
                // tip
                showTimeout: 500,
                // timeout before showing the tip (in
                // milliseconds 1000 == 1 second)
                hideTimeout: 100,
                // timeout before hiding the tip
                timeOnScreen: 0,
                // timeout before automatically hiding the
                // tip after showing it (set to > 0 in order
                // to activate)
                showOn: "hover",
                // handler for showing the tip ('hover',
                ...
                showAniDuration: 300,
                // show animation duration - set to 0 if
