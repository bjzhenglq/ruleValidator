define(function(require, exports, module) {
	require("../theme/default/css/jquery.ui.core.css");
...
(function($, undefined) {
			...
			$.each(["Width", "Height"], function(i, name) {
				...
				function reduce(elem, size, border, margin) {
					$.each(side, function() {
								size -= parseFloat($.curCSS(elem, "padding"
												+ this, true))
										|| 0;
								if (border) {
			...
			// support
			$(function() {
						var body = document.body, div = body
								.appendChild(div = document
										.createElement("div"));

						// access offsetHeight before setting the style to
						// prevent a
						// layout bug
						// in IE 9 which causes the elemnt to continue to take
						// up space
						// even
