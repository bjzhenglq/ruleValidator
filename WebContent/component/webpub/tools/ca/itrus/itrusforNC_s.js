define(function(require, exports, module) {
			var $ = require("$");
			var filterCerts = require("./pta").filterCerts;
			var itruspta = "<object id='iTrusPTA' codebase='itruscertctl.cab#version=2,5,3,0' classid='clsid:1E0DFFCF-27FF-4574-849B-55007349FEDA'></object>"
			var secureTool = "<object id='SecureTool' codebase='itruscertctl.cab#version=3, 2, 11, 504' classid='clsid:0AA5FDF3-548C-4907-96A3-8C12CAC1932D'></object>"
			var epassPin = "<object ID='VerPin' codebase='itruscertctl.cab#Version=1,0,10,1129' classid='clsid:A94C8ACE-2A80-4CFB-8D2B-64859FCC30FD'></object>"
			$("body").append($("<div>").html(itruspta + secureTool + epassPin));
			function getSN(ncid) {
				var m = 0;
			...
			function signmessage(message, ncid) {
				...
				var b64Cert = cert.GetEncodedCert(2); // base64编码
				var alg = "sha1";
						...
						for (var k = 0; k < str2.length; k++) {
							...
							if (str3[0] == 'UID') {
								...
								if (NCUserIdentifier == ncid) {
									var cert = arrayCerts[i]; // base64编码
									return cert;
								}
							}
						}
