define(function(require, exports, module) {
			...
			function filterCerts(arrayIssuerDN, dateFlag, serialNumber) {
				var iTrusPTA = document.getElementById("iTrusPTA");
			...
			function signMessage(plainText, signCert, opt) {
				...
				try {
					...
					if ((e.number == -2147483135) || e.number == -2146881278 // cancel
							|| e.number == -2146434962 // FT2001 PIN Login
														// canceled
					) {
			...
			function signFileEx(srcFileName, destFileName, signCert, opt) {
				...
				try {
					// opt = typeof(opt) ==
					// "number"?opt|OUTPUT_BASE64:OUTPUT_BASE64;
			...
			/*******************************************************************
			 * 该功能是去掉通过控件获取到的证书主题字符串结束符。 参数为当前证书对象 返回值为证书主题subject
			 ******************************************************************/
			...
			/*******************************************************************
			 * 该功能是去掉通过控件获取到的证书颁发者主题字符串结束符。 参数为当前证书对象 返回值为证书颁发者主题Issuer
			 ******************************************************************/
			...
			/**
			 * put Add new key param: key - String, key name param: value -
			...
			/**
			 * get Return an element param: key - String, key name Return:
			...
			/**
			 * getKey Return: The first key contains the given value, or null if
			 * not found
			 */
			 ...
			 * by the ASCII characters ", " (comma and space). Each entry is
			 * rendered as the key, an equals sign =, and the associated
			 * element, where the toString method is used to convert the key and
			 * element to strings. Return: a string representation of this
			 * hashtable.
			 */
