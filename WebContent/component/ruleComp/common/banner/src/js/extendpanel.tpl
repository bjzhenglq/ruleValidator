<div class="top_banner w_100ps">
	...
	<div class="banner_right">
		...
		<div class="banner_top">
			<div class="hotline">
				<span id="topInfo" class="floatleft font_yahei">产品热线：</span> <span
					id="topInfoContent" class="floatleft font_arial">800-400-5662</span> <span
			...
			<div class="account_func">
				...
				<div class="separator">
					<span title="收藏夹" class="favorite_icon"></span> <span
						class="floatleft mrg_l5px"> <a
						href="{{G.PAGE.ACCOUNT_FAVORITE}}" target="_blank">收藏夹</a> </span>
				</div>
				<div class="separator">
