...
<div class="cart_checkout">
		...
		<div id="panelCartList" class="dialog_panel">
			...
			<div class="panel_content">
									...
									{#foreach $T as shopCart}
										...
										{#/if}
												...
												<td class="align_right">
													{$T.shopCart.corigcurrencyid_curSign}
												...
												<td class="align_left">
													<label>
														<input value="{$T.shopCart.count}"
															maxlength=15
															scale="{$T.shopCart.pk_measdoc_unitScale}"
												...
												<td class="align_right">
													<span>{$T.shopCart.corigcurrencyid_curSign}</span>
													<span class="ET_caclSummy"
														scale="{$T.shopCart.corigcurrencyid_amountScale}"></span>
												</td>
												<td class="align_center"><a href="" class="ET_delShopCartRow" productid="{$T.shopCart.cproductid}">删除</a></td>
											</tr>
										{#/foreach}
								</tbody>
							</table>
				...
				<textarea id="templet_shopCartDelLabel" class="hidden">
						...
						<div class="dlist_btm">
                            <div class="list_total font_yahei">
                                <span
								class="list_clear">[ <a href="#" class="ET_clearDelShopCart">清空</a> ]</span>
                            </div>
                    	</div>
					</textarea>
			</div>
			...
			<div class="panel_btm">
				...
				<div class="button_pane">
					<a href="#" class="btn_blue font_hei ET_checkOut" target="_blank">去结算</a> <a
						href="#" class="btn_gray font_hei ET_closeShopCart">关闭</a>
				</div>
			</div>
		</div>
	</div>
	...
	<a href="#" class="checkout ET_checkOut" target="_blank">
