define(function(require, exports, module) {
	 ...
	 */
	function addResource(grid,dom) {
		var that = dom;
		//行政区划
		var contentHtml = "<iframe id='addressEdit' data-resize='true' src='"+G.PAGE.RESOURCE_EDIT+"' frameborder='0' scrolling='no' width='450px' height='200px'></iframe>";
		Dialog.dialog({
			title : '新增资源',
			hasCloseTip : true,
			content : contentHtml,
	 ...
	 * 修改资源
	 */
	function updateResource(record, grid) {
		//获取主键
		var pk = record.resourceId||"";
		var contentHtml = "<iframe id='addressEdit' data-resize='true' frameborder='0' scrolling='no' src='"+G.PAGE.RESOURCE_EDIT+"?pkUser="+pk+"' width='450px' height='200px'></iframe>";
		Dialog.dialog({
			title : '修改资源信息',
			hasCloseTip : true,
			content : contentHtml,
	 ...
	 * 删除用户
	 */
	function delResource(record, grid) {
		// [0] 获取主键
		var dataModel = {};
